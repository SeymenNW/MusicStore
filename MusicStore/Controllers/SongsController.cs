...
namespace MusicStore.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AlbumId,GenreId,ArtistId,Title")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AlbumId,GenreId,ArtistId,Title")] Song song)
        {
            if (id != song.Id)
            {
                return NotFound();
